        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <p className="text-gray-600 text-sm md:text-sm leading-relaxed">
              Professional makeup artistry for your special moments. Enhancing
              natural beauty with expertise and care.
            </p>
          </div>
            ...
            <ul className="space-y-3">
              <li>
                <a
                  ...
                  className="text-gray-600 hover:text-rose-400 transition-colors text-sm"
                >
                  Home
                </a>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start text-gray-600 text-sm">
                ...
                <span>Sugar land, Texas United States</span>
              </li>
              ...
              <li className="flex items-center text-gray-600 text-sm">
                ...
                <a
                  href="mailto:bolasoile@yahoo.com"
                  className="hover:text-rose-400 transition-colors"
                >
                  bolasoile@yahoo.com
                </a>
